...
estimation(datafile=fsdat,nobs=192,loglinear,mh_replic=2000,mh_nblocks=2,mh_jscale=0.8,mh_drop=0.45,smoother,forecast=5,bayesian_irf,moments_varendo,filtered_vars,load_mh_file,mode_compute=0,mode_file=fs2000a_mode,load_mh_file) P_obs Y_obs gp_obs gy_obs c;
